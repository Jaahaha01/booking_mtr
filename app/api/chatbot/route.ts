...
export async function POST(req: NextRequest) {
	try {
		...
		// ═══════════════════════════════════════════════
		// 4. สถานะการจอง / ประวัติ (ต้องเช็คก่อน "จอง")
		// ═══════════════════════════════════════════════
		if (matchAny(lc, ['สถานะ', 'ประวัติ', 'ดูการจอง', 'เช็คการจอง', 'ตรวจสอบ', 'booking status', 'จองไว้', 'การจองของ', 'ผลการจอง'])) {
			return NextResponse.json({
				reply: '� <b>ดูสถานะ/ประวัติการจอง</b>\n\n' +
					'<b>📌 ดูประวัติการจอง:</b>\n' +
					'• กดที่ <b>"โปรไฟล์"</b> มุมขวาบน\n' +
					'• เลือก <b>"ประวัติการจอง"</b>\n\n' +
					'<b>📌 ดูสถานะการจอง:</b>\n' +
		...
		// ═══════════════════════════════════════════════
		// 5. ยกเลิก / เปลี่ยนแปลงการจอง (ต้องเช็คก่อน "จอง")
		// ═══════════════════════════════════════════════
		if (matchAny(lc, ['ยกเลิก', 'cancel', 'เปลี่ยนการจอง', 'แก้ไขการจอง', 'ไม่ต้องการจอง', 'ลบการจอง'])) {
			return NextResponse.json({
				reply: '❌ <b>วิธียกเลิกการจอง</b>\n\n' +
					'1️⃣ กดเมนู <b>"สถานะการจอง"</b> ด้านบน\n' +
					'2️⃣ เลือกรายการจองที่ต้องการยกเลิก\n' +
					'3️⃣ กดปุ่ม <b>"ลบ"</b> หรือ <b>"ยกเลิก"</b>\n\n' +
					'⚠️ สามารถยกเลิกได้เฉพาะการจองที่ยังไม่ถึงเวลาเท่านั้นครับ'
			});
		}
		...
		// 6. วิธีจองห้อง
		// ═══════════════════════════════════════════════
		if (matchAny(lc, ['จองยังไง', 'วิธีจอง', 'จองห้อง', 'อยากจอง', 'ขั้นตอนการจอง', 'จองตรงไหน', 'จองได้ที่', 'กดจอง', 'book room', 'จองได้ไหม', 'จองอย่างไร'])) {
			return NextResponse.json({
				reply: '📋 <b>วิธีจองห้องประชุม</b>\n\n' +
					...
					'4️⃣ กรอก <b>หัวข้อและรายละเอียด</b> การประชุม\n' +
